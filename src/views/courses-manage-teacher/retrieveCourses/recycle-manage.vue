...
import { retrieveRecycleQuestions, reductionRecycleQuestions} from '@/libs/api';
...
export default {
                    ...
                    return h('div', [
                        h(
                            'Button',
                            {
                                ...
                                on: {
                                    click: () => {
                                        this.handelCategoryStatus(params.row);
                                    }
                                }
                            },
                            '还原'
  ...
  methods: {
        getList() {
            retrieveRecycleQuestions(this.userId, this.courseId).then(res => {
                if (res.data.data) {
